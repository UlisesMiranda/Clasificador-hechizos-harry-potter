...
from src.utils import grabar_audio_dir
from src.modelo_reconocimiento_voz import ModeloReconocimientoVozHarryPotter
import os

NOMBRE_MODELO = "../models/modelo_2024082317.h5"
...
def grabar_audio():
    ...
    hechizo = modelo.predict_audio(audio_file)
...
CARPETA_AUDIOS_SALIDA = 'pruebas_audios'

# Eliminar todos los archivos de la carpeta
for archivo in os.listdir(CARPETA_AUDIOS_SALIDA):
    ruta_completa = os.path.join(CARPETA_AUDIOS_SALIDA, archivo)
